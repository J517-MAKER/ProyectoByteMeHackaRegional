...
def create_case(data):
    ...
    case = SearchCase(f'BUS-2026-{number:04d}', person, data.get('missing_date') or 'Desconocida', store.now(),
                      ...
                      reference_status='Referencia procesada · simulación' if person.photos else 'Sin referencia fotográfica')
...
def add_case_photo(case_id,content,content_type):
    ...
    case.reference_status='Referencia procesada · simulación'
